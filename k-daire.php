...
<div class="content"><!-- Content Section -->
    <div class="explore-rooms margint30 clearfix"><!-- Explore Rooms Section -->
        <div class="container">
            <div class="row">
                <?php
                $urunsor=$db->prepare("SELECT * from urunler where urun_kategori=2 order by urun_id ASC");
                ...
                if($count==0){?>
                    <h1 style="color:crimson; font-family: 'Times New Roman';  "class="title text-center"><b>Kiralık Dairemiz Bulunmamaktadır.</b></h1>
                    <?php
