...
<div class="breadcrumb breadcrumb-1 pos-center" style="background: url(trex/<?php echo $settingsprint['ayar_title4']; ?>) no-repeat fixed; width: 100%;">
    <h1> SATILIK VİLLA & KÖŞK & KONAK & YALI</h1>
</div>
<div class="content"><!-- Content Section -->
    <div class="explore-rooms margint30 clearfix"><!-- Explore Rooms Section -->
        <div class="container">
            <div class="row">
                <?php
                $urunsor=$db->prepare("SELECT * from urunler where urun_kategori=7 order by urun_id ASC");
                ...
                if($count==0){?>
                    <h1 style="color: darkblue ; font-family: 'Times New Roman'; "class="title text-center"><b>Satılık Villa&Köşk&Konak&Yalı Bulunmamaktadır.</b></h1>
                    <?php
