...
<div class="content"><!-- Content Section -->
    <div class="explore-rooms margint30 clearfix"><!-- Explore Rooms Section -->
        <div class="container">
            <div class="row">
                <?php
                $urunsor=$db->prepare("SELECT * from urunler where urun_kategori IN (11,12) order by urun_id ASC");
                ...
                if($count==0){?>
                    <h1 style="color: purple; font-family: 'Times New Roman'; "class="title text-center"><b>İşyeri İlanımız Bulunmamaktadır.</b></h1>
                    <?php
