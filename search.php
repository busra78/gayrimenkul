...
<?php
$Id = htmlspecialchars(trim($_GET['location']));
$kategori1 = htmlspecialchars(trim($_GET['sehir']));
...
$kategori = $db->prepare("SELECT * from kategoriler where kategori_id='$Id' ");
$kategori->execute(array(0));
$kategori_bilgi = $kategori->fetch(PDO::FETCH_ASSOC);

$sehir = $db->prepare("SELECT * from kategorilerp where kategori_id='$kategori1' ");
$sehir->execute(array(0));
$sehir_bilgi = $sehir->fetch(PDO::FETCH_ASSOC);
?>
...
<div class="content"><!-- Content Section -->
    <div class="explore-rooms margint30 clearfix"><!-- Explore Rooms Section -->
        <div class="container">
            <div class="row">
                <?php
                $urunsor=$db->prepare("SELECT * from urunler where urun_kategori='$Id' and urun_title3='$kategori1'");
                    ...
                    <div class="col-lg-4 col-sm-6 marginb30">
                        <div class="home-room-box">
                            ...
                            <div class="room-details" style="height: 50px;">
                                <p>         <h4> <?php echo $urun_baslik ?><h4></p>
                            </div>
                ...
                if($count==0){?>
                    <h1 style="color: blue ; font-family: 'Times New Roman'; "class="title text-center"><?php echo $kategori_bilgi['kategori_ad'];?> Kategorisinde <?php echo $sehir_bilgi['kategori_ad'];?> Şehrinde Aradığınız Sonuç Bulunmamaktadır.</h1>
                    <?php
